...
public class ComboButton {
  ...
  public ComboButton whenPressed(final Command command) {
    s_shift.negate().and(m_button).whenActive(command);
    return this;
  }
  public ComboButton whenPressed(final Command command, boolean interuptable) {
    s_shift.negate().and(m_button).whenActive(command, interuptable);
    return this;
  }

  public ComboButton whenShiftPressed(final Command command) {
    s_shift.and(m_button).whenActive(command);
    return this;
  }
  public ComboButton whenShiftPressed(final Command command, boolean interuptable) {
    s_shift.and(m_button).whenActive(command, interuptable);
    return this;
  }
}